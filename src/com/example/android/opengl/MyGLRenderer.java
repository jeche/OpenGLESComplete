...
//    private Square   mSquare;
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        try {
			mesh = hammer.loadMesh("hammer", "alduinNoStripe.obj");
		} catch (Exception e) {
...
//        mSquare   = new Square();
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        Matrix.setLookAtM(viewMatrix, 0, 0, 0, -8f, 0f, 0f, 0f, 0f, 5.0f, 0.0f);
...
//        Matrix.setRotateM(mRotationMatrix, 0, mAngle, 0, 0, -1.0f);
        ...
        MyGLRenderer.checkGlError("Matrix multiply");

        // Draw triangle
//        mTriangle.draw(mMVPMatrix);
        if(mesh != null){
        	mesh.draw(MVPMatrix, MVMatrix);
        }
    }
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        Matrix.frustumM(projMatrix, 0, -ratio, ratio, -1, 2, 3, 20 );
